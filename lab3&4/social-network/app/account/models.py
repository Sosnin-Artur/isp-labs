...
class Profile(models.Model):
    ...
    github_account = models.URLField(("профиль GitHub"), max_length=255, blank=True, null=True)

    birth_date = models.DateField('Дата рождения', null=True, blank=True)

    short_bio = models.CharField(("что-то о себе"), max_length=60, blank=True, null=True)
